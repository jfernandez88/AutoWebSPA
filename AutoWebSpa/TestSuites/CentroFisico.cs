...
namespace AutoWebSpa.TestSuites.CentroFisico
{
 [TestFixture]  
 [Parallelizable]
    public class CentroFisico : SeleniumExtentReport
    {
        public CentroFisico() { }
        ...
        public void CentroFisico_Alta()
        {
            ...
            Alta.SeleccionarModulo("Centro Físico", Driver, detalleReporte);
        ...
        [Test]
        public void CentroFisico_Modificar()
        {
        ...
        [Test]
        public void CentroFisico_Auditar()
        {
