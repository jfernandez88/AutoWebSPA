...
namespace AutoWebSpa.TestSuites.Zona
{
 [TestFixture]  
 [Parallelizable]
    public class Zonas : SeleniumExtentReport
    {
        public Zonas()  { }
        ...
        public void Zonas_Alta()
        {
            ...
            int Nro = rnd.Next(900);
                ...
                Alta.SeleccionarModulo("Zonas", Driver, detalleReporte);
