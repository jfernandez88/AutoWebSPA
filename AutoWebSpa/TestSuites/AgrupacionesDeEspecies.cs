...
namespace AutoWebSpa.TestSuites.AgrupacionesDeEspecies
{
 [TestFixture]  
 [Parallelizable]
    public class AgrupacionesDeEspecies: SeleniumExtentReport
    {
        public AgrupacionesDeEspecies(){ }
        ...
        [Test]
        public void AgrupacionesDeEspecies_Alta()
        {
            ...
            Alta.SeleccionarModulo("Agrupaciones de Especies", Driver, detalleReporte);
        ...
        [Test]
        public void AgrupacionesDeEspecies_Baja()
        {
        ...
        [Test]
        public void AgrupacionesDeEspecies_Modificar()
        {
        ...
        [Test]
        public void AgrupacionesDeEspecies_Auditar()
        {
