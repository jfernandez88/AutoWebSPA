...
namespace AutoWebSpa.TestSuites.HorizonteDeInversion
{
 [TestFixture]  
 [Parallelizable]
    public class HorizonteDeInversion : SeleniumExtentReport
    {
        public HorizonteDeInversion() { }
        ...
        [Test]
        public void HorizonteDeInversion_Alta()
        {
            ...
            int Nro = rnd.Next(900);
                ...
                Alta.SeleccionarModulo("Horizonte de Inversión", Driver, detalleReporte);
        ...
        [Test]
        public void HorizonteDeInversion_Baja()
        {
        ...
        [Test]
        public void HorizonteDeInversion_Modificar()
        {
        ...
        [Test]
        public void HorizonteDeInversion_Auditar()
        {
